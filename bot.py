...
from database import get_player, update_player, get_all_players, add_shop_item, create_event
...
async def weekly_income_job(context):
    ...
    for p in players:
        try:
            await context.bot.send_message(p[0],
                "⚔️ *هفته جدید آغاز شد!*\n\nدرآمد هفتگی قلمروهای وستروس واریز شد.\nسرزمین‌هایتان را گسترش دهید! 🏰",
                parse_mode="Markdown")
        except: pass
